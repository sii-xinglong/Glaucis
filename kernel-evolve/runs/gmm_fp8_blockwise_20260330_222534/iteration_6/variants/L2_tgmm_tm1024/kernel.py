"""GMM block-wise FP8 quantization kernel for TPU -- L2_tgmm_tm1024 variant.
...
This variant decreases tgmm TM from 2048 to 1024, halving the M-tile size
in the tgmm pass. Tests if smaller tgmm TM reduces overhead -- tgmm with
TM=2048 may cause excessive register pressure or memory traffic when the
M dimension is large.
...
def gmm_fp8_blockwise(
    ...
    L2_tgmm_tm1024 variant: tgmm TM 2048->1024 to test reduced overhead.
