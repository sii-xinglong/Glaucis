...
def gmm_fp8_blockwise(
    ...
    tiling: tuple[int, ...] = (512, 1024, 512, 512, 512, 1024, 512, 512, 512),
) -> jnp.ndarray:
    """GMM with fp8_blockwise quantization and tokamax backend.

    Phase-specific tiling:
      Forward GMM:   (512, 1024, 512) - large M/K tiles for [8192,2048]@[G,2048,512]
      Backward GMM:  (512, 512, 1024) - large N tile for transpose_rhs pass
      Backward TGMM: (512, 512, 512)  - balanced tiles for transposed groups
    """
    tile_size = 128
