...
# Variant: bwd_monolithic — single fused backward kernel (monolithic dq+dk+dv+dh)
"""fused_chunk_simple_gla Pallas TPU kernel — L1 + forward 4-step unrolling + monolithic backward.
