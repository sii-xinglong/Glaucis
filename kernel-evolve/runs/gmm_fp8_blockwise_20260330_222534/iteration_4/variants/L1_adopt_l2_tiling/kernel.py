"""GMM block-wise FP8 quantization kernel for TPU -- L1_adopt_l2_tiling variant.
...
Cross-pollination: adopts L2's winning bwd_gmm tiling (TM=256, TK=512)
into L1's kernel. L2 proved that bwd_gmm TM=256+TK=512 is superior to
L1's original bwd_gmm TM=1024+TK=256.
  - Forward gmm:  (256, 512, 128) -- L1's fwd_tk512 tiling
  - Backward gmm: (256, 512, 128) -- L2's winning tiling (was 1024, 256, 128)
...
def gmm_fp8_blockwise(
    ...
    L1_adopt_l2_tiling variant: cross-pollination with phase-specialized tiling
