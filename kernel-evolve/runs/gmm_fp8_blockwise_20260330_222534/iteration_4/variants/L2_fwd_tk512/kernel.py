"""GMM block-wise FP8 quantization kernel for TPU -- fwd_tk512 variant.

Builds on L2_bwd_tm256_tk512 (which proved TM=256 + bwd TK=512 effective).
This variant increases forward TK from 256 to 512, halving K-loop iterations
in the forward gmm pass while maintaining per-group alignment.
...
L2_bwd_tm256_tk512 used (256,256,128, 256,512,128, 2048,512,128). This variant
changes forward TK from 256 to 512:
...
def gmm_fp8_blockwise(
    ...
    fwd_tk512 variant: phase-specialized tiling with
