"""GMM block-wise FP8 quantization kernel for TPU -- L1_fwd_tn256 variant.
...
in the forward gmm pass. For Gate/Up (N=512), this means 2 N-iterations
instead of 4. For Down (N=2048), 8 iterations instead of 16.
...
def gmm_fp8_blockwise(
    ...
    L1_fwd_tn256 variant: forward TN 128->256 to halve N-loop iterations.
